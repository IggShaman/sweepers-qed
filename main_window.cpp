...
MainWindow::MainWindow() : ui_{new Ui::MainWindow} {
    ...
    connect(a, &QAction::triggered, game_board_widget_, &GameBoardWidget::switch_point_mode);
    a->setCheckable(true);
    ui_->toolBar->addAction(a);
...
void MainWindow::solver_result_slot(Solver::FeedbackState feedback_state, miner::Location l,
                                    size_t range) {
